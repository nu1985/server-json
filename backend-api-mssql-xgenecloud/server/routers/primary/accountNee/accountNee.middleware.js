...
class AccountNeeMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./accountNee.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./accountNee.policy').acl);
  }


  async default (req, res, next) {

    console.log('AccountNee middleware;')
...
module.exports = AccountNeeMiddleware;