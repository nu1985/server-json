...
class AccountdetailMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./accountdetail.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./accountdetail.policy').acl);
  }


  async default (req, res, next) {

    console.log('Accountdetail middleware;')
...
module.exports = AccountdetailMiddleware;