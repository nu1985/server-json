...
class AccountrecMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./accountrec.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./accountrec.policy').acl);
  }


  async default (req, res, next) {

    console.log('Accountrec middleware;')
...
module.exports = AccountrecMiddleware;