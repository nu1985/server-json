...
class AmphurMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./amphur.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./amphur.policy').acl);
  }


  async default (req, res, next) {

    console.log('Amphur middleware;')
...
module.exports = AmphurMiddleware;