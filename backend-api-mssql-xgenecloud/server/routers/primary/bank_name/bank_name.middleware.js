...
class BankNameMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./bank_name.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./bank_name.policy').acl);
  }


  async default (req, res, next) {

    console.log('BankName middleware;')
...
module.exports = BankNameMiddleware;