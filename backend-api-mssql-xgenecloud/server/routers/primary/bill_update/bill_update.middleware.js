...
class BillUpdateMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./bill_update.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./bill_update.policy').acl);
  }


  async default (req, res, next) {

    console.log('BillUpdate middleware;')
...
module.exports = BillUpdateMiddleware;