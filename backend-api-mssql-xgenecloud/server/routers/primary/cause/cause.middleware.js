...
class CauseMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./cause.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./cause.policy').acl);
  }


  async default (req, res, next) {

    console.log('Cause middleware;')
...
module.exports = CauseMiddleware;