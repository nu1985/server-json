...
class Cause1Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./cause1.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./cause1.policy').acl);
  }


  async default (req, res, next) {

    console.log('Cause1 middleware;')
...
module.exports = Cause1Middleware;