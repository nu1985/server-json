...
class ChangNameMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./chang_name.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./chang_name.policy').acl);
  }


  async default (req, res, next) {

    console.log('ChangName middleware;')
...
module.exports = ChangNameMiddleware;