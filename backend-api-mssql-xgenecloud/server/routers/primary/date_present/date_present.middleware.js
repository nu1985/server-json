...
class DatePresentMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./date_present.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./date_present.policy').acl);
  }


  async default (req, res, next) {

    console.log('DatePresent middleware;')
...
module.exports = DatePresentMiddleware;