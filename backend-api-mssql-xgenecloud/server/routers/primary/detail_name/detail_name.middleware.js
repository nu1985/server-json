...
class DetailNameMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./detail_name.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./detail_name.policy').acl);
  }


  async default (req, res, next) {

    console.log('DetailName middleware;')
...
module.exports = DetailNameMiddleware;