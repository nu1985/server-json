...
class DetailPayMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./detail_pay.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./detail_pay.policy').acl);
  }


  async default (req, res, next) {

    console.log('DetailPay middleware;')
...
module.exports = DetailPayMiddleware;