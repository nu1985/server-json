...
class GeographyMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./geography.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./geography.policy').acl);
  }


  async default (req, res, next) {

    console.log('Geography middleware;')
...
module.exports = GeographyMiddleware;