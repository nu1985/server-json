...
class Mem1Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./mem1.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./mem1.policy').acl);
  }


  async default (req, res, next) {

    console.log('Mem1 middleware;')
