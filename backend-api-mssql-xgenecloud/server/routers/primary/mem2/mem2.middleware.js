...
class Mem2Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./mem2.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./mem2.policy').acl);
  }


  async default (req, res, next) {

    console.log('Mem2 middleware;')
