...
class Mem3Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./mem3.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./mem3.policy').acl);
  }


  async default (req, res, next) {

    console.log('Mem3 middleware;')
