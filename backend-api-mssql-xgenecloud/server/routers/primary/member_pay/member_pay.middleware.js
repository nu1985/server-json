...
class MemberPayMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./member_pay.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./member_pay.policy').acl);
  }


  async default (req, res, next) {

    console.log('MemberPay middleware;')
...
module.exports = MemberPayMiddleware;