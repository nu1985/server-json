...
class MonBank1Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monBank1.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monBank1.policy').acl);
  }


  async default (req, res, next) {

    console.log('MonBank1 middleware;')
...
module.exports = MonBank1Middleware;