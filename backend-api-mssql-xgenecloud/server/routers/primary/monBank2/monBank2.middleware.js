...
class MonBank2Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monBank2.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monBank2.policy').acl);
  }


  async default (req, res, next) {

    console.log('MonBank2 middleware;')
...
module.exports = MonBank2Middleware;