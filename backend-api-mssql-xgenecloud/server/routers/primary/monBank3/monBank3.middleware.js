...
class MonBank3Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monBank3.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monBank3.policy').acl);
  }


  async default (req, res, next) {

    console.log('MonBank3 middleware;')
...
module.exports = MonBank3Middleware;