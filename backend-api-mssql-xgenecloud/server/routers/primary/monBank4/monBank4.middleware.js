...
class MonBank4Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monBank4.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monBank4.policy').acl);
  }


  async default (req, res, next) {

    console.log('MonBank4 middleware;')
...
module.exports = MonBank4Middleware;