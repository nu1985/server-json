...
class MonJayMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monJay.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monJay.policy').acl);
  }


  async default (req, res, next) {

    console.log('MonJay middleware;')
...
module.exports = MonJayMiddleware;