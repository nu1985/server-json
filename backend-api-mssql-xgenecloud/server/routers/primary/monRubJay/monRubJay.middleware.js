...
class MonRubJayMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monRubJay.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monRubJay.policy').acl);
  }


  async default (req, res, next) {

    console.log('MonRubJay middleware;')
...
module.exports = MonRubJayMiddleware;