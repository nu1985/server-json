...
class MonhugMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monhug.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monhug.policy').acl);
  }


  async default (req, res, next) {

    console.log('Monhug middleware;')
...
module.exports = MonhugMiddleware;