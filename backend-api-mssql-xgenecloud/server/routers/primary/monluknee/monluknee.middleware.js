...
class MonlukneeMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monluknee.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monluknee.policy').acl);
  }


  async default (req, res, next) {

    console.log('Monluknee middleware;')
...
module.exports = MonlukneeMiddleware;