...
class Monpay4Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monpay4.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monpay4.policy').acl);
  }


  async default (req, res, next) {

    console.log('Monpay4 middleware;')
...
module.exports = Monpay4Middleware;