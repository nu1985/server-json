...
class MonsodMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monsod.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monsod.policy').acl);
  }


  async default (req, res, next) {

    console.log('Monsod middleware;')
...
module.exports = MonsodMiddleware;