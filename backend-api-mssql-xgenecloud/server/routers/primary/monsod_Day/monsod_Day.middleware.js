...
class MonsodDayMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./monsod_Day.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./monsod_Day.policy').acl);
  }


  async default (req, res, next) {

    console.log('MonsodDay middleware;')
...
module.exports = MonsodDayMiddleware;