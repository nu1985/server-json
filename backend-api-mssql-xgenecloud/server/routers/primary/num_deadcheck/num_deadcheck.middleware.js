...
class NumDeadcheckMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./num_deadcheck.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./num_deadcheck.policy').acl);
  }


  async default (req, res, next) {

    console.log('NumDeadcheck middleware;')
...
module.exports = NumDeadcheckMiddleware;