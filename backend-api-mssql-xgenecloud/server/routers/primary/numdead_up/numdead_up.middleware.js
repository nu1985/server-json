...
class NumdeadUpMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./numdead_up.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./numdead_up.policy').acl);
  }


  async default (req, res, next) {

    console.log('NumdeadUp middleware;')
...
module.exports = NumdeadUpMiddleware;