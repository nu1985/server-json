...
class NumnotpayMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./numnotpay.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./numnotpay.policy').acl);
  }


  async default (req, res, next) {

    console.log('Numnotpay middleware;')
...
module.exports = NumnotpayMiddleware;