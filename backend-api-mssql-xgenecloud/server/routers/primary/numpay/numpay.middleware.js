...
class NumpayMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./numpay.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./numpay.policy').acl);
  }


  async default (req, res, next) {

    console.log('Numpay middleware;')
...
module.exports = NumpayMiddleware;