...
class NumpayMemnewMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./numpay_memnew.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./numpay_memnew.policy').acl);
  }


  async default (req, res, next) {

    console.log('NumpayMemnew middleware;')
...
module.exports = NumpayMemnewMiddleware;