...
class NumpayMonthMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./numpay_month.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./numpay_month.policy').acl);
  }


  async default (req, res, next) {

    console.log('NumpayMonth middleware;')
...
module.exports = NumpayMonthMiddleware;