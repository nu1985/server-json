...
class NumpayYearsMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./numpay_years.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./numpay_years.policy').acl);
  }


  async default (req, res, next) {

    console.log('NumpayYears middleware;')
...
module.exports = NumpayYearsMiddleware;