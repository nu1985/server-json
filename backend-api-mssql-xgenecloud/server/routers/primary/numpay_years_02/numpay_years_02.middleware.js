...
class NumpayYears02Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./numpay_years_02.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./numpay_years_02.policy').acl);
  }


  async default (req, res, next) {

    console.log('NumpayYears02 middleware;')
...
module.exports = NumpayYears02Middleware;