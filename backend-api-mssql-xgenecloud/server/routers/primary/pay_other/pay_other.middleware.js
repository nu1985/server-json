...
class PayOtherMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./pay_other.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./pay_other.policy').acl);
  }


  async default (req, res, next) {

    console.log('PayOther middleware;')
...
module.exports = PayOtherMiddleware;