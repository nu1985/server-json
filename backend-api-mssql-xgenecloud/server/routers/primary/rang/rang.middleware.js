...
class RangMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./rang.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./rang.policy').acl);
  }


  async default (req, res, next) {

    console.log('Rang middleware;')
