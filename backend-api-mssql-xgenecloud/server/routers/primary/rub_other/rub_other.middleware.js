...
class RubOtherMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./rub_other.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./rub_other.policy').acl);
  }


  async default (req, res, next) {

    console.log('RubOther middleware;')
...
module.exports = RubOtherMiddleware;