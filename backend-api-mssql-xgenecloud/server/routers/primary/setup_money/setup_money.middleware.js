...
class SetupMoneyMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./setup_money.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./setup_money.policy').acl);
  }


  async default (req, res, next) {

    console.log('SetupMoney middleware;')
...
module.exports = SetupMoneyMiddleware;