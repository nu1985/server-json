...
class SinpeememMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./sinpeemem.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./sinpeemem.policy').acl);
  }


  async default (req, res, next) {

    console.log('Sinpeemem middleware;')
...
module.exports = SinpeememMiddleware;