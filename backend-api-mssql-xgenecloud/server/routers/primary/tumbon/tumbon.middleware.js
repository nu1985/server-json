...
class TumbonMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./tumbon.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./tumbon.policy').acl);
  }


  async default (req, res, next) {

    console.log('Tumbon middleware;')
...
module.exports = TumbonMiddleware;