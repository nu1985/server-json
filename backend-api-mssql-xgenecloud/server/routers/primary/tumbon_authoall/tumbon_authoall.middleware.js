...
class TumbonAuthoallMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./tumbon_authoall.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./tumbon_authoall.policy').acl);
  }


  async default (req, res, next) {

    console.log('TumbonAuthoall middleware;')
...
module.exports = TumbonAuthoallMiddleware;