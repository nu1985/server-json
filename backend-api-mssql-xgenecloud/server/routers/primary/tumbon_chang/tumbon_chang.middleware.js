...
class TumbonChangMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./tumbon_chang.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./tumbon_chang.policy').acl);
  }


  async default (req, res, next) {

    console.log('TumbonChang middleware;')
...
module.exports = TumbonChangMiddleware;