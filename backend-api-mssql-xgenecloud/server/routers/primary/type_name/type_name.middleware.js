...
class TypeNameMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./type_name.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./type_name.policy').acl);
  }


  async default (req, res, next) {

    console.log('TypeName middleware;')
...
module.exports = TypeNameMiddleware;