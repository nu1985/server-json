...
class TypeName2Middleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./type_name_2.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./type_name_2.policy').acl);
  }


  async default (req, res, next) {

    console.log('TypeName2 middleware;')
...
module.exports = TypeName2Middleware;