...
class UserlogAllMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./userlog_all.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./userlog_all.policy').acl);
  }


  async default (req, res, next) {

    console.log('UserlogAll middleware;')
...
module.exports = UserlogAllMiddleware;