...
class VillageMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./village.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./village.policy').acl);
  }


  async default (req, res, next) {

    console.log('Village middleware;')
...
module.exports = VillageMiddleware;