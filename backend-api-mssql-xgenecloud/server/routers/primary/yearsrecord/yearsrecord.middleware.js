...
class YearsrecordMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./yearsrecord.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./yearsrecord.policy').acl);
  }


  async default (req, res, next) {

    console.log('Yearsrecord middleware;')
...
module.exports = YearsrecordMiddleware;