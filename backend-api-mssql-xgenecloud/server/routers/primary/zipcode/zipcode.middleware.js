...
class ZipcodeMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./zipcode.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./zipcode.policy').acl);
  }


  async default (req, res, next) {

    console.log('Zipcode middleware;')
...
module.exports = ZipcodeMiddleware;